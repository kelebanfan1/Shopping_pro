...
if (!Math) {
  (_easycom_XtxSwiper + PageSkeletion)();
}
const PageSkeletion = () => "./components/PageSkeletion.js";
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const getCategoryData = async () => {
      const res = await services_category.getCategoryAPI();
      categoryList.value = res.result;
    };
    const isFinish = common_vendor.ref(false);
    common_vendor.onLoad(async () => {
      await Promise.all([getBanerData(), getCategoryData()]);
      isFinish.value = true;
    });
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/uniapp-pro/heima-shop/src/pages/category/category.vue"]]);
