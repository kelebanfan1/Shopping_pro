...
<template>
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      ...
      <view class="action">
        ...
        <view class="item arrow">
          <text class="label" @tap="openPopup('service')">服务</text>
    ...
    <view class="detail panel">
      ...
      <view class="content">
        ...
        <!-- 图片详情 -->
        <image mode="widthFix" v-for="item in goods?.mainPictures" :key="item" :src="item"></image>
      </view>
    </view>
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    <view class="icons">
      ...
      <navigator class="icons-button" url="/pages/cart/cartGood" open-type="navigate">
  ...
  <!-- uni-ui 弹出层 -->
  <uni-popup background-color="white" ref="popup" type="bottom">
