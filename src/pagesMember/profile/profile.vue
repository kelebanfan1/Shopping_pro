...
//修改性别
const onChange: UniHelper.RadioGroupOnChange = (ev) => {
...
const onChangefullLocation: UniHelper.RegionPickerOnChange = (ev) => {
  /* 修改前端页面 */
    ...
    <view class="form">
      ...
      <view class="form-content">
        ...
        <view class="form-item">
          ...
          <input class="input" v-model="profile!.nickname" type="text" placeholder="请填写昵称" />
        </view>
        <view class="form-item">
        ...
        <view class="form-item">
          ...
          <input class="input" v-model="profile!.profession" type="text" placeholder="请填写职业" />
        </view>
      </view>
      <!-- 提交按钮 -->
